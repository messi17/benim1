document.addEventListener('DOMNodeInserted', checkForPlayer);

function checkForPlayer() {
    console.log('Checking');
    if (typeof jwplayer != 'undefined') {
        console.log('JWplayer defined');
        if (typeof jwplayer() === 'object') {
            console.log('JWPlayer is object');
            ...
            if (videoPlayer.getViewable()) {
                console.log('JWPlayer is visible');
                ...
                if (videoPlayerWrapper) {
                    if (theatreModeActive == false) {
                        ...
                        if (controlBarPresent) {
                            ...
                            document.removeEventListener('DOMNodeInserted', checkForPlayer);
                        }
                    }
                }
            }
